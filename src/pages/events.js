...
import Every1 from "../images/events/machine_Learning/Everyone.jpg";
import Every1with from "../images/events/machine_Learning/EveryWithProject.jpg";
import stud1 from "../images/events/machine_Learning/StudentGroupPic.jpg";
import stud1with from "../images/events/machine_Learning/StudentWithProject.jpg";
...
const Events = () => {
  ...
  const machineLearning = [
    {
      img: Every1,
      description: "Every one in the team to make this a sucess",
    },
    // {
    //   img: Every1with,
    //   description: "The team with student and there project",
    // },
    {
      img: stud1,
      description: "The student group pictures",
    },
    {
      img: stud1with,
      description: "Group pictures with student and there project",
    },
  ];
      ...
      <div className="mt-24">
        <div className="flex flex-col space-y-3 mt-10">
          ...
          <span className="text-md text-slate-600">
            This text are just placeholder: Boost your productivity in the digital age with our hands-on
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 md:gap-10">
          {machineLearning.map((event, index) => (
