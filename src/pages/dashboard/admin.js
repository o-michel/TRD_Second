...
//                 <div className="flex flex-col items-center gap-12 p-10 rounded-lg h-96 bg-gray-50 profile">
...
//                                     Intro to JavaScript
//                                 </td>
//                                 <td className='px-4 py-8'>4</td>
//                                 <td className='px-4 py-8'>Published</td>
