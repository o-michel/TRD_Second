...
//     return (
//         <div className="container flex h-full gap-20 mx-auto mt-20 bg-black xl:bg-green-400">
//             <section className="flex flex-col gap-14 side_bar w-96">
...
//                         <li className='mt-4'>My Profile</li>
...
//                 <div className="grid grid-cols-3 gap-10 courses gap-y-10">
...
//                                             <div>
//                                                 <h3 className='text-2xl'>{instructor.instructor.lastName} {instructor.instructor.firstName}</h3>
//                                                 <p>Instructor</p>
...
//                                 </div>
//                             </div>
//                             <h2 className="mt-6 text-3xl text-blue-500 title">{course.courseID.name}</h2>
...
//                                 <img className='object-cover w-16 h-16 mr-4 rounded-full' src={course_img} alt="course_img" />
//                                 <div>
//                                     <h3 className='text-2xl'>Ismail</h3>
//                                     <p>Instructor</p>
